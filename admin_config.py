...
def admin_kb():
    return ReplyKeyboardMarkup(keyboard=[
        [KeyboardButton(text="💹 Manual kurslar"),   KeyboardButton(text="💳 To'lov kartalari")],
        [KeyboardButton(text="📦 Buyurtmalar"),       KeyboardButton(text="📢 Kanallar")],
        [KeyboardButton(text="👥 Foydalanuvchilar"), KeyboardButton(text="📨 Broadcast")],
